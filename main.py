...
PROJECT_PATH = os.getenv('RIG_CARROS_PATH', r"C:\Users\pc\Documents\Repositorios\TECNICAL_ART_\rig_carros")
...
def reload_rig_carros():
    ...
    try:
        ...
        import rig_carros.cadena_joints as cadena_joints
        importlib.reload(cadena_joints)
        print("✅ cadena_joints recargado")

        import rig_carros.curvas_control as curvas_control
        importlib.reload(curvas_control)
        print("✅ curvas_control recargado")

        import rig_carros.jerarquia as jerarquia
        importlib.reload(jerarquia)
        print("✅ jerarquia recargado")

        import rig_carros.skinning as skinning
        importlib.reload(skinning)
        print("✅ skinning recargado")
